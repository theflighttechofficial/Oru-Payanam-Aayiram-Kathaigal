...
export default function Dashboard() {
  ...
  // Desktop-only: MobileBar's ENGINE button covers ignition on a phone;
  // the full gauge/switch panel doesn't fit a narrow screen cleanly.
  return (
    <div className="dash-wrap desktop-only" style={styles.wrap}>
